package Gui; /******************************************************************************
 *  Compilation:  javac Gui.StdDraw.java
 *  Execution:    java Gui.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code Gui.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code Gui.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">Gui.StdDraw.java</a>
 ...
 *           Gui.StdDraw.setPenRadius(0.05);
 *           Gui.StdDraw.setPenColor(Gui.StdDraw.BLUE);
 *           Gui.StdDraw.point(0.5, 0.5);
 *           Gui.StdDraw.setPenColor(Gui.StdDraw.MAGENTA);
 *           Gui.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code Gui.StdDraw.line()} and {@code Gui.StdDraw.point()}
 *  draw lines and points; the methods {@code Gui.StdDraw.setPenRadius()}
 *  and {@code Gui.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code Gui.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code Gui.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code Gui.StdDraw.setPenColor(Gui.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code Gui.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code Gui.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   Gui.StdDraw.setFont(font);
 *   Gui.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code Gui.StdDraw.clear(Gui.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   Gui.StdDraw.setScale(-2, +2);
 *   Gui.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       Gui.StdDraw.clear();
 *       Gui.StdDraw.filledCircle(x, y, 0.05);
 *       Gui.StdDraw.filledCircle(-x, -y, 0.05);
 *       Gui.StdDraw.show();
 *       Gui.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code Gui.StdDraw.BLACK}, {@code Gui.StdDraw.BLUE}, {@code Gui.StdDraw.CYAN},
     * {@code Gui.StdDraw.DARK_GRAY}, {@code Gui.StdDraw.GRAY}, {@code Gui.StdDraw.GREEN},
     * {@code Gui.StdDraw.LIGHT_GRAY}, {@code Gui.StdDraw.MAGENTA}, {@code Gui.StdDraw.ORANGE},
     * {@code Gui.StdDraw.PINK}, {@code Gui.StdDraw.RED}, {@code Gui.StdDraw.WHITE}, and
     * {@code Gui.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Gui.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Gui.StdDraw)
        try {
            URL url = Gui.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
